...
from .data_preprocessing import TrafficPreprocessor  # Updated import
...
class AnalysisEngine:
    def __init__(self, pcap_file_instance):
        ...
        try:
            ...
            self.preprocessor = TrafficPreprocessor()  # Class instance
    ...
    def run(self):
        try:
            ...
            # Step 2: Preprocess ➝ Dataset (Updated preprocessing call)
